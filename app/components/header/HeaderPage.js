        ...
        <div className={activeItem !== 'home' ? styles.pagesMobileHeader : ""}>
          ...
          <div id='home' className={activeItem === 'home' ? styles.landingBackground : ""}>
            <MediaQuery query='(min-device-width: 985px)'>
              <Menu className={styles.menu} pointing secondary color={'yellow'}>
                <Menu.Menu position='right'>
                  ...
                  <Menu.Item className={styles.menuItem} content='Leadership' name='leadership' active={activeItem === 'leadership'} onClick={this.handleMenuClick} />
            ...
            <MediaQuery query='(max-device-width: 984px)'>
              { visible ? 
                ( <Icon style={{float: 'right', color: 'white', margin: '10px', position: 'relative'}} name='close' size='big' onClick={this.toggleVisibility} /> )
                :
                ( <Icon style={{float: 'right', color: 'white', margin: '10px', position: 'relative'}} name='bars' size='big' onClick={this.toggleVisibility} /> )
              }
